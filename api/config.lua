...
function pfUI:LoadConfig()
  ...
  pfUI:UpdateConfig("global",     nil,           "whoclassicons",    "1")
  ...
  pfUI:UpdateConfig("appearance", "bags",        "internalsort",     "0")
  ...
  pfUI:UpdateConfig("unitframes", nil,           "druidmanatarget",  "1")
  ...
  pfUI:UpdateConfig("unitframes", nil,           "druidmanaspace",   "0")
