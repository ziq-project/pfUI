pfUI_translation["deDE"] = {
  ...
  ["Druid Mana Bar"] = "Druiden-Manaleiste",
  ["Druid Mana Bar Height"] = "Höhe der Druiden-Manaleiste",
  ["Druid Mana Bar Width"] = "Breite der Druiden-Manaleiste",
  ["Druid Mana Bar X-Offset"] = "X-Versatz der Druiden-Manaleiste",
  ["Druid Mana Bar Y-Offset"] = "Y-Versatz der Druiden-Manaleiste",
  ["Druid Mana Bar Spacing"] = "Abstand der Druiden-Manaleiste",
  ["Druid Mana Bar Texture"] = "Textur der Druiden-Manaleiste",
  ["Druid Mana Bar Text"] = "Text der Druiden-Manaleiste",
  ["Elastic Zoom"] = nil,
  ...
  ["Show Druid Mana Bar"] = "Druiden-Manaleiste anzeigen",
  ["Show Druid Mana Bar On Target"] = "Druiden-Manaleiste am Ziel anzeigen",
