pfUI:RegisterModule("gui", "vanilla:tbc", function ()
  ...
  do -- Generate Config UI
    ...
    CreateGUIEntry(T["Settings"], T["General"], function()
      ...
      CreateConfig(nil, T["Show Class Icons in Who List"], C.global, "whoclassicons", "checkbox")
    end)
    ...
    CreateGUIEntry(T["Bags & Bank"], nil, function()
      ...
      CreateConfig(nil, T["Enable Built-In Bag Sort Button (requires /reload)"], C.appearance.bags, "internalsort", "checkbox")
      CreateConfig(nil, T["Bag Sort: Fill From Opposite End"], C.appearance.bags, "sortreverse", "checkbox")
      CreateConfig(nil, T["Bag Sort: Reverse Category Order"], C.appearance.bags, "sortprioreverse", "checkbox")
    ...
    CreateGUIEntry(T["Loot"], nil, function()
      ...
      CreateConfig(nil, T["Auto-Show Loot History On New Roll"], C.loothistory, "autoshow", "checkbox")
