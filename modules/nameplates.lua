pfUI:RegisterModule("nameplates", "vanilla:tbc", function ()
  ...
  nameplates.OnDataChanged = function(self, plate)
    ...
    if unittype == "ENEMY_PLAYER" and C.nameplates["enemyclassc"] == "1" and class then
      local color = pfUI:GetClassColor(class)
      r, g, b, a = color.r, color.g, color.b, 1
    elseif unittype == "FRIENDLY_PLAYER" and C.nameplates["friendclassc"] == "1" and class then
      local color = pfUI:GetClassColor(class)
      r, g, b, a = color.r, color.g, color.b, 1
    end
    ...
    if r + g + b ~= plate.cache.namecolor and unittype == "FRIENDLY_PLAYER" and C.nameplates["friendclassnamec"] == "1" and class then
