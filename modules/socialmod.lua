    ...
    hooksecurefunc("FriendsList_Update", function()
      ...
      for i=1, FRIENDS_TO_DISPLAY do
        ...
        if connected then
          ...
          local ccolor = pfUI:GetClassColor(L["class"][class]) or { 1, 1, 1 }
    ...
    hooksecurefunc("WhoList_Update", function()
      ...
      for i=1, WHOS_TO_DISPLAY do
        ...
        if class then
          ...
          -- do we have classicons? (skin enabled?) and are they wanted?
          if classicon and C.global.whoclassicons == "1" then
            classtext:Hide()
            ...
            classtext:Show()
            classtext:SetTextColor(color.r,color.g,color.b,1)
          end
        end
